...
{
    static readonly Lock ProvidersLock = new();
    static readonly Dictionary<string, IStcProvider> RegisteredProviders = new(StringComparer.OrdinalIgnoreCase);
            ...
            CancellationToken cancellationToken = default)
    {
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            try
            {
                return await provider.FetchAsync(config, lengthLimitation, cancellationToken);
            }
